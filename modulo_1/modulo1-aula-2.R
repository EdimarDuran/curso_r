...
# Funcao "read_excel()"
dados_ibge <- read_excel("aula_2_-_27-08/dados_ibge.xlsx")
...
barplot(porc_regiao,
        main = "Distrubuicao por região") # "main" adiciona título

barplot(porc_regiao,
        main = "Distrubuicao por região", 
...
barplot(porc_regiao,
        ...
        las = 1, 
        cex.lab = 1.5, 
        ylim = c(0, 60)) # "ylim" altera os limites no eixo y
barplot(porc_regiao,
        main = "Distrubuicao por regiao", 
        cex.main = 1.5, 
        ylab = "Percentual", 
